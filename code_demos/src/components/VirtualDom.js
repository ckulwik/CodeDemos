  ...
  const list = (side) => {
    ...
    return (
      <>
        ...
        <button
          onClick={() =>
            side === "left" ? leftHandleClick() : rightHandleClick()
          }
        >
  ...
  return (
    <div className="page-container">
      ...
      <div className="input-container">
        ...
        <input
          className="numRecolors-input"
          value={numRecolors}
          onChange={(event) => setNumRecolors(event.target.value)}
        ></input>
      </div>
      <div className="demo-container">
        <div className="left-side">
          ...
          <div className="list-contents">
            <div className="list">{list("left")}</div>
            <div>
              <p>
                In this example, the color of the items is being stored as a
                state variable. The color state variable is updated, and then
                the new style is applied via in-line styling. The VD allows
                changes to be applied on it first, before actually changing the
                DOM. B/c the VD is not rendered, changes to it are cheap. Along
                with batching changes, the VD approach is much faster.
              </p>
              <div>
                <p className="code">
                  const [leftColor1, setLeftColor1] =
                  useState(startingColors[0]);
                </p>
                <p>...</p>
                <p className="code">setLeftColor1(newColor)</p>
        ...
        <div className="right-side">
          ...
          <div className="list-contents">
            <div className="list">{list("right")}</div>
            <div>
              <p>
                This side is using direct DOM manipulation to change the styling
                of the items. Updating the DOM after manipulation is
                inneficient, and has a slower performance than React's Virtual
                DOM.
              </p>
              <div>
                <p className="code">
